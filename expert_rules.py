...
def reconnect_maintained_lines(name, maintenance_list, ep_step, action_space, obs):
    act = None
...
def expert_rules(name, maintenance_list, ep_step, action_space, obs):
    act = None

    act = reconnect_maintained_lines(
        name, maintenance_list, ep_step, action_space, obs)
