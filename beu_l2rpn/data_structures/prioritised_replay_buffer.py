import numpy as np
import torch
from beu_l2rpn.data_structures.deque import Deque
from beu_l2rpn.data_structures.max_heap import MaxHeap
...
class PrioritisedReplayBuffer(MaxHeap, Deque):
    ...
    def __init__(self, hyper_parameters, seed=0):
        MaxHeap.__init__(self, hyper_parameters["buffer_size"], dimension_of_value_attribute=5, default_key_to_use=0)
        Deque.__init__(self, hyper_parameters["buffer_size"], dimension_of_value_attribute=5)
        np.random.seed(seed)
        ...
        self.alpha = hyper_parameters["alpha_prioritised_replay"]
        self.beta = hyper_parameters["beta_prioritised_replay"]
        self.incremental_td_error = hyper_parameters["incremental_td_error"]
