...
def train(env,
    ...
    training_param: :class:`l2rpn_baselines.utils.TrainingParam`
        The parameters describing the way you will train your DeepQSimple.
    ...
    .. code-block:: python
        ...
        # define the name of the DeepQSimple
        nm_ = "AnneOnymous"
        try:
            train(env,
                  name=nm_,
    ...
    if load_path is not None:
        ...
        if verbose:
            print("INFO: Reloading a DeepQSimple, the architecture parameters will be ignored")
    ...
    if load_path is not None:
        if verbose:
            print("INFO: Reloading a DeepQSimple, training parameters will be ignored")
